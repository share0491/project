...
?>
<form id="leaveForm" class="form-horizontal" method="post" action="index.php?loc=do_records">
	...
	<div class="form-group">
		<label class="col-xs-11 col-md-12 control-label" style="text-align:left;">Comment :</label>
	...
	<input type="hidden" value="<?php echo $_GET["id"];?>" name="record_id"/>
		<input class="btn btn-success" type="submit" name="approve_btn" value="Approve" onclick='return confirm("Confirm Approve this Applicantion?");'></td>
		<input class="btn btn-danger" type="submit" name="reject_btn" value="Reject" onclick='return confirm("Confirm Reject this Applicantion?");'></td>
	</div>
</form>